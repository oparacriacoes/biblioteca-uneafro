...
!(function () {
    ...
    $(document).ready(function () {
        ...
        function checkScroll() {
            var scrollTop = isWindows ? $(".ps").scrollTop() : $(window).scrollTop();
            if (50 < scrollTop) {
        ...
        function checkNavbarPosition() {
            ...
            if ($(".row").length > 0 && scrollTop > a.top) {
                $(".navbar-minimize-fixed").css("opacity", "1");
            } else {
                $(".navbar-minimize-fixed").css("opacity", "0");
            }
    ...
    $(window).resize(function () {
        if (
            ((seq = seq2 = 0),
            0 == $full_screen_map.length && 0 == $(".bd-docs").length)
        ) {
            var a = $navbar
    ...
    (blackDashboard = {
        ...
        showSidebarMessage: function (a) {
            try {
                $.notify(
                    { icon: "tim-icons ui-1_bell-53", message: a },
                    {
                        type: "info",
                        timer: 4e3,
